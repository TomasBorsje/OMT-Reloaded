...
import com.tomasborsje.omtreloaded.items.AbstractTurretBlockItem;
...
public class ModItems {
    ...
    // Block items
    public static final DeferredItem<BlockItem> TURRET_BASE_ITEM = ITEMS.registerItem("turret_base", (props) -> new AbstractTurretBlockItem(ModBlocks.TURRET_BASE.get(), props));
